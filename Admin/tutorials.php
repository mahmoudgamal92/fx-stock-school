        ...
        <div class="content-body">
			...
			<div class="container-fluid">
                <div class="form-head d-flex mb-3  mb-lg-5   align-items-start">
					<a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#addTutorialModal">New Tutorial</a>
					...
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">New Tutorial</h5>
								<button type="button" class="close" data-dismiss="modal"><span>&times;</span>
								</button>
							</div>
							<div class="modal-body">
								<form method = "POST" action="Action/tutorials/insert.php"  enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-12">
									<div class="form-group">
								<label class="text-black font-w500"> Content URL </label>
								<input type="text" name="url" class="form-control">
									...
									<input type="file" name="thumnail" class="btn form-control" accept=".png, .jpg, .jpeg">
                                    ...
                                    <table class="table table-responsive-md">
										...
										?>
											<tr>
												...
												<div class="d-flex align-items-center">
														<a 
														onclick="return confirm('هل أنت متأكد من حذف هذا الحتوي التعليمي ؟ ')"
														
														href="Action/tutorials/delete.php?id=
