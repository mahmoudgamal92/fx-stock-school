					...
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method = "POST" action="Action/settings/service-insert.php">
								<div class="row">
									<div class="col-md-6">
									<div class="form-group">
										<label class="text-black font-w500">Title AR</label>
									...
									<div class="col-md-6">
									<div class="form-group">
										<label class="text-black font-w500">Description AR</label>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                             ...
                             <a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#addUserModal">New Service</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    href="Action/settings/service-delete.php?id=
                                                    <?php echo $row['id']; ?>" 
