...
$result = mysqli_query($con,$cmd);
$signal = mysqli_fetch_array($result);
?>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Edit Current Signal</h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="Action/signals/update.php">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                value="<?php echo $signal['open_price']?>"
                                                >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                value="<?php echo $signal['stop_loss']?>"
                                                >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                value="<?php echo $signal['take_profit_1']?>"
                                                >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                value="<?php echo $signal['take_profit_2']?>"
                                                >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="gain_pip" class="form-control">
                                            </div>
                                        </div>
