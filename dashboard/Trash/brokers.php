                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="Action/settings/broker-insert.php"
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                             <h4 class="card-title">Brokers List</h4>
                             <a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#addUserModal">New Broker</a>
                            </div>
                            <div class="card-body">
