                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"> New SEO Word</h5>
                                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form method="POST" action="Action/settings/seo-insert.php"
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <h4 class="card-title">SEO List</h4>
                                ...
                                <a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#addUserModal">New SEO Word</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                    <a 
                                                    href="Action/settings/seo-delete.php?id=
                                                    <?php echo $row['id']; ?>" 
